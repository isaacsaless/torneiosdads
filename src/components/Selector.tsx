interface SelectorProps {
  ...
  export default function Selector({ activePage, setActivePage }: SelectorProps) {
    return (
      <div className="w-full bg-gradient-to-t from-[#3b3b3b] to-[#1f1f1f] max-xs:h-24">
        <div className="flex flex-col justify-start items-start mx-5 h-full py-5 overflow-x-auto whitespace-nowrap">
